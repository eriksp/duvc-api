...
if ($InstallDuvc) {
    try {
        $duvcExeUrl = 'https://github.com/eriksp/duvc-api/releases/download/v1.6.0/duvc-api.exe'
        $duvcShaUrl = 'https://github.com/eriksp/duvc-api/releases/download/v1.6.0/duvc-api.exe.sha256'
