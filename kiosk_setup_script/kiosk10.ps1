...
if ($InstallDuvc) {
    try {
        $duvcExeUrl = 'https://github.com/eriksp/duvc-api/releases/download/v1.7.1/duvc-api.exe'
        $duvcShaUrl = 'https://github.com/eriksp/duvc-api/releases/download/v1.7.1/duvc-api.exe.sha256'
